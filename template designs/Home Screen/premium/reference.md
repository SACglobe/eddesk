# Premium Template: Home Screen Conditions & Reference

This document serves as the reference for rendering the Home Screen in the **Premium** template.
...
10. **Gallery**: Positioned below Infrastructure.
11. **Events**: Positioned below Gallery.
12. **Footer**: Contact info from `contactdetails`.
