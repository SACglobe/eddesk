...
export const COL_SCHOOLS_LOGO_URL = "logourl";
...
export const COL_SCHOOLS_POSTAL_CODE = "postalcode";
...
export const COL_SCHOOLS_PAYMENTGATEWAY_URL = "paymenturl"; // Added back
...
export const COL_LEADERSHIP_QUOTE = "quote";
...
export const COL_PRINCIPAL_MESSAGE_QUOTE = "quote";
