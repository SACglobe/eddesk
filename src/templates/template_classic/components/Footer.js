            ...
            <div className="max-w-[1600px] mx-auto px-2 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 border-b border-emerald-900 pb-12">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            {showLogo ? (
                                <div className="flex-shrink-0 h-12 w-auto flex items-center group-hover:scale-110 transition-transform duration-500 bg-white p-1 rounded">
                                    <img
                                        src={school.logoUrl}
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-[10px] text-emerald-600 uppercase tracking-[0.2em] font-bold">
                    ...
                    <p className="mt-4 md:mt-0 flex items-center gap-2">
                        Powered by <a href="https://www.eddesk.in" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-white transition-colors underline decoration-emerald-800 underline-offset-4">EdDesk</a>
                    </p>
                </div>
            </div>
        </footer>
