            ...
            <div className="fade-in pt-48 pb-32">
                <div className="max-w-7xl mx-auto px-6">
                    <header className="mb-32 max-w-4xl">
                        <SectionHeader title="About Us" subtitle={`${schoolName} Legacy`} />
                        <h1 className="text-6xl md:text-8xl font-serif mb-12 leading-tight">
                            {aboutTitle || `${schoolName}:`} <br />
                            <span className="italic text-signature-gold">{aboutTitle ? '' : 'Excellence in Education.'}</span>
                        </h1>
                    ...
                    {identityEnabled && hasIdentityData && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-40">
                            <div className="bg-signature-navy text-white p-12 relative group overflow-hidden">
                                ...
                                <p className="text-2xl font-serif italic leading-relaxed">{vision || `To be a global benchmark in education, fostering leaders at ${schoolName}.`}</p>
                            </div>
                            <div className="bg-signature-gold text-white p-12 relative group overflow-hidden">
                                ...
                                <p className="text-2xl font-serif italic leading-relaxed">{mission || `To provide a holistic and rigorous academic environment at ${schoolName}.`}</p>
                            </div>
                            <div className="bg-signature-ivory border border-signature-navy/5 p-12 flex flex-col justify-center">
                                ...
                                <p className="text-4xl font-serif text-signature-navy tracking-tight uppercase truncate">{motto || "Excellence"}</p>
                            </div>
                        </div>
                    )}
                        ...
                        <section className="mb-40 grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
                            <div className="lg:col-span-7 pt-12">
                                ...
                                <div className="space-y-8 text-xl font-light text-signature-navy/80 leading-loose">
                                    <p className="font-serif italic text-3xl text-signature-navy mb-12 border-l-4 border-signature-gold pl-10">
                                        "{chairman.message || `Our commitment to excellence at ${schoolName} ensures that every student receives a world-class education.`}"
                                    </p>
                                    <div className="pt-8">
                            ...
                            <div className="lg:col-span-5 sticky top-32 lg:order-last order-first">
                                <div className="relative">
                                    {chairman.imageUrl ? (
                                        <img src={chairman.imageUrl} className="w-full aspect-[4/5] object-cover grayscale border border-signature-navy/10 shadow-2xl" alt={chairman.name} />
                                    ) : (
                    ...
                    {getComponent('leadership')?.isActive && hasPrincipalData && (
                        <section className="mb-40 grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
                            ...
                            <div className="lg:col-span-7 pt-12">
                                <SectionHeader title="Principal's Message" subtitle="Academic Leadership" />
                                <div className="space-y-8 text-xl font-light text-signature-navy/80 leading-loose">
                                    <p className="font-serif italic text-3xl text-signature-navy mb-12 border-l-4 border-signature-gold pl-10">
                                        "{principal.message || `At ${schoolName}, education is not merely the transmission of data; it is the forging of character and intellectual tradition.`}"
                                    </p>
                                    <p>Our faculty serve not just as teachers but as mentors and stewards of the intellectual tradition. We invite you to join a community where excellence is the standard.</p>
                                </div>
                            </div>
                        </section>
                    )}
                    ...
                    {getComponent('whychooseus')?.isActive && whyChooseUs.length > 0 && (
                        ...
                        <SectionHeader title="Why Choose Us" subtitle={`${schoolName} Value`} light />
