...
export const LOCAL_TENANT_DATA = {
  ...
  // ── achievements ───────────────────────────────────────────────────
  achievements: [
    { id: 'ac-01', school_id: 'demo-school-001', year: 2024, category: 'Board Examinations', title: 'State Rank 3 – Class 12 Science', description: 'Priya Sharma secured State Rank 3 in Tamil Nadu Board, Class 12 Science with 598/600.', photo_url: '', achievement_type: 'academic', display_order: 1 },
    { id: 'ac-02', school_id: 'demo-school-001', year: 2024, category: 'Football', title: 'State U-17 Football Champions', description: 'Our U-17 team won the State Championship in Chennai, defeating 24 schools.', photo_url: '/school/image/sports_athletics.png', achievement_type: 'sports', display_order: 2 },
    { id: 'ac-03', school_id: 'demo-school-001', year: 2024, category: 'National Recognition', title: 'Best CBSE School – South India', description: 'Awarded by the Education Excellence Foundation at National School Awards 2024.', photo_url: '', achievement_type: 'recognition', display_order: 3 },
    { id: 'ac-04', school_id: 'demo-school-001', year: 2023, category: 'Science Olympiad', title: 'National Science Olympiad – Gold', description: 'Arjun Mehta won Gold at the National Science Olympiad, competing against 1,200 students.', photo_url: '', achievement_type: 'academic', display_order: 4 },
    { id: 'ac-05', school_id: 'demo-school-001', year: 2023, category: 'Swimming', title: 'District Swimming – 3 Gold Medals', description: 'Our team won 3 golds and 2 silvers at the District Swimming Championships.', photo_url: '/school/image/sports_basketball.png', achievement_type: 'sports', display_order: 5 },
    { id: 'ac-06', school_id: 'demo-school-001', year: 2023, category: 'ISO Certification', title: 'ISO 9001:2015 Certified', description: 'Received ISO 9001:2015 certification for quality management in education.', photo_url: '', achievement_type: 'recognition', display_order: 6 },
    { id: 'ac-07', school_id: 'demo-school-001', year: 2022, category: 'Debate', title: 'South Zone Inter-School Debate Champions', description: 'Our team won first place at the South Zone Inter-School English Debate Championship.', photo_url: '', achievement_type: 'academic', display_order: 7 },
  ],
  ...
  // ── events ─────────────────────────────────────────────────────────
  events: [
    { id: 'e-01', school_id: 'demo-school-001', event_date: '2026-02-21', start_time: '08:30:00', end_time: '13:00:00', title: 'Annual Sports Day', category: 'Sports', description: 'Athletic celebration with track events, team sports finals, and prize distribution. Parents welcome.', location: 'School Ground', is_featured: true },
    { id: 'e-02', school_id: 'demo-school-001', event_date: '2026-02-22', start_time: '09:00:00', end_time: '12:00:00', title: 'Parent–Teacher Meeting', category: 'Academic', description: 'Quarterly PTM for all classes. Individual 10-minute slots. Bring your child\'s report card.', location: 'Respective Classrooms', is_featured: false },
    { id: 'e-03', school_id: 'demo-school-001', event_date: '2026-02-25', start_time: '10:00:00', end_time: '17:00:00', title: 'Science & Technology Fair', category: 'Academic', description: 'Grade 6–12 students showcase STEM projects. Open to public and industry judges.', location: 'Auditorium & School Grounds', is_featured: true },
    { id: 'e-04', school_id: 'demo-school-001', event_date: '2026-02-25', start_time: '18:00:00', end_time: '21:00:00', title: 'Annual Cultural Night', category: 'Cultural', description: 'An evening of music, dance, drama, and art. Performances by students across all grades.', location: 'Performing Arts Theatre', is_featured: true },
    { id: 'e-05', school_id: 'demo-school-001', event_date: '2026-02-25', start_time: '09:00:00', end_time: '12:00:00', title: 'Inter-House Debate Competition', category: 'Academic', description: 'Annual debate championship between all four school houses. Topic announced on the day.', location: 'Main Auditorium', is_featured: false },
  ],
