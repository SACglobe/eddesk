  ...
  hero_media: [
    {
      ...
      media_type:             'image',
      media_url:              '/demo/hero-1.jpg',
      headline:               'Empowering Minds, Shaping Futures',
      subheadline:            'A world-class education rooted in Indian values',
      primary_button_text:    'Apply for Admission',
      primary_button_url:     '/admissions',
      secondary_button_text:  'Take a Virtual Tour',
      secondary_button_url:   '/tour',
      display_order:          1,
      is_active:              true,
    },
    {
      ...
      school_id:              'demo-school-001',
      media_type:             'image',
      media_url:              '/demo/hero-2.jpg',
      headline:               'Excellence in Sports & Academics',
      subheadline:            'State-level champions for 5 consecutive years',
      primary_button_text:    'Our Achievements',
      primary_button_url:     '/achievements',
    ...
    },
    {
      ...
      school_id:              'demo-school-001',
      media_type:             'video',
      media_url:              '/demo/campus-tour.mp4',
      headline:               'Experience Our Campus',
      subheadline:            'Modern infrastructure built for tomorrow\'s learners',
      primary_button_text:    'Schedule a Visit',
