...
- proxy rewrites tenant domains to /demo/[template_id]/[...path]
...
## Rules
1. NEVER modify the rewrite logic without updating both proxy.ts AND constants
...
5. The proxy must stay edge-compatible (no Node.js APIs)
